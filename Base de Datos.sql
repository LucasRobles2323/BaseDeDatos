...
CREATE TABLE IF NOT EXISTS `mydb`.`Departamento` (
  ...
  `esOperativo` ENUM('0', '1') NOT NULL DEFAULT '0', -- 0 = Administrativo  | 1 = Operativo
...
-- -----------------------------------------------------
-- Table `mydb`.`Departamento_Administrativo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Departamento_Administrativo` (
  `codigoUnicoAdministrativo` INT NOT NULL,
  `fechaIniGerente` DATETIME NOT NULL,
  `nombre` VARCHAR(45) NOT NULL,
  `idGerenteDep` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`codigoUnicoAdministrativo`),
  UNIQUE INDEX `codigoUnicoOperativo_UNIQUE` (`codigoUnicoAdministrativo` ASC),
  UNIQUE INDEX `IdGerenteDep_UNIQUE` (`idGerenteDep` ASC))
ENGINE = InnoDB;
